...
#define GLM_ENABLE_EXPERIMENTAL
    ...
    #include <vulkan/../../glm-src/glm/gtx/hash.hpp>
#else
    #include <glm/glm.hpp>
...
private:
    ...
    void createImageViews() {
        ...
        for (size_t i = 0; i < this->swapChainImages.size(); i++) {
            this->swapChainImageViews[i] = createImageView(this->swapChainImages[i], swapChainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT, 1);
        }
    }
